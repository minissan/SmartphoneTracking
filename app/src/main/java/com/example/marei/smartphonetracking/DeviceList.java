...
public class DeviceList extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int listId = getIntent().getIntExtra("layout_list", com.example.marei.smartphonetracking.R.layout.device_list);
        ...
        scanButton = (Button) findViewById(com.example.marei.smartphonetracking.R.id.button_scan);
        ...
        int layout_text = getIntent().getIntExtra("layout_text", com.example.marei.smartphonetracking.R.layout.device_name);
        mPairedDevicesArrayAdapter = new ArrayAdapter<String>(this, layout_text);

        // Find and set up the ListView for paired devices
        ListView pairedListView = (ListView) findViewById(com.example.marei.smartphonetracking.R.id.list_devices);
